...
#include <stdlib.h>
#include <string.h>
#include "LinkedList.h"//#include "../inc/LinkedList.h"
...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        {
          returnAux=0;//returnAux = addNode(this, ll_len(this), pElement);
        }
    }
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if(this != NULL && index >=0 && index < cantidad)
    {
...
int ll_clear(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        ...
        {
            ll_remove(this,i);//if(ll_remove(this,i)==-1){break;  flag=0}
        }
        /*if(flag==0)
        {
            returnAux=0;
...
int ll_isEmpty(LinkedList* this)
{
    ...
    if(this != NULL)
    {
        if(tam == 0)// pregunto si la lista esta vacia
        {
            returnAux = 1;
        }
        else
...
{
    return addNode(this, index, pElement);// addNode termina haciendo lo mismo que pide push so,nos alcanza con poner return addNode
}
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
        if(ll_indexOf(this,pElement)==-1)// valido si contiene el elemento
        {
            returnAux = 0;
        }else
        {
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    int i;
    //void* pElement=NULL;         from<=ll_len(this)
...
/** \brief Devuelve un nuevo linkedlist cargados con los elementos que pasan la funcion filtro
 *
 * \return LinkedList* this likedList a filtrar
 * \param int (*pFunc)(void*) puntero a la funcion que filtra
 * \return nuevo puntero a linkedList con los elementos que pasan la funcion filtro
 *
 */
    ...
    if(this!=NULL && pFunc!=NULL)
    {
        ...
        if(listaFiltrada!=NULL)
        {
            ...
            for(int i=0;i<len;i++)
            {
                ...
                if(pFunc(pAux))
                {
                    if(ll_add(listaFiltrada,pAux)!=0)
                    {
